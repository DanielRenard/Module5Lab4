...
router.get('/filter', (req, res) => {
    ...
    if (filterFirstLetter) {
        matchingFriends = matchingFriends.filter(friend => friend.name.charAt(0) === filterFirstLetter)
    }
...
router.get('/:id', (req, res) => {
    ...
    let matchingFriend = friends.find(friend => friendId == friend.id)
    ...
    // 'id' here will be a value matching anything after the / in the request path
...
router.put('/:id', (req, res) => {
    ...
    //set friends array to a new copy of the array with the included friend at that id
    //replacing one that was found

    // findFriend = updatedFriend 
